...
{
    protected $signature = 'add-spec {name : Name of the specification} {--path= : Path to .zeri directory} {--force : Force overwrite existing specs and proceed with dirty working directory} {--with-branch : Create a git branch for this specification} {--branch-prefix=feature/ : The prefix for the git branch}';
    ...
    {
        // Only create branch if --with-branch flag is provided
        if (! $this->option('with-branch')) {
            return true;
        }
